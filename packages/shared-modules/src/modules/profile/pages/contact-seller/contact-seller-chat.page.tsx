...
import { ImageIcon, SendIcon } from "@repo/ui/components/icons/index";
  ...
  if (showSubjectGate) {
    return (
      <div className="flex-grow flex flex-col h-full">
        ...
        <div className="flex-grow flex flex-col justify-center px-4 pb-8 max-w-md mx-auto w-full gap-4">
          ...
          <div className="space-y-2">
            ...
            <div className="flex gap-2 items-end">
              ...
              <Button
                ...
                size="icon"
                onClick={handleSend}
                disabled={sendMutation.isPending || (!text.trim() && pendingImages.length === 0)}
                aria-label={t("send")}
              >
